...
global hrir_l hrir_r; % Globals for CIPIC impulse responses left and right. Loaded in roomsim_setup.m
global H3D; % Global for MIT impulse response data. Loaded in roomsim_setup.m
%***************************
