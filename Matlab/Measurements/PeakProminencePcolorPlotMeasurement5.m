...
DistanceDifferenceMatrixPeakPromFilteredMeasurement5Lin = reshape(DistanceDifferenceMatrixPeakPromFilteredMeasurement5,1,[]);
...
title('Distance measurement error (Omnidirectional Speaker Peak Prominence 0.65)')
