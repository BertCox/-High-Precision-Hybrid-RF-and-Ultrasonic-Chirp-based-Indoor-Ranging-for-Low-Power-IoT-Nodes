...
% 1) A previously saved *.mat file.
% 2) Input from an Excel spreadsheet file or from a text file.(Allows non-Excel users a stored editable input form.)
% 3) Manual input via dialogue prompts.
% Choice 3 above will be given the option to save resulting setup data as a MAT file for future use.
%------------------------------------------------------------------------------------- 
